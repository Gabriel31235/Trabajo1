...
namespace Trabajo1.Formas
{
    public partial class FormaGato : Form
    {
        ...
        public void IniciarJuego()
        {
            ...
            Gato = new int[3, 3];
            YaHayGanador = false;
            picGanador.Image = Properties.Resources.;
            ...
            for (var i = 0; i < 3; i++)
            {
                for (var j = 0; j < 3; j++)
                {
                    ...
                    FichaJuego.Image = Properties.Resources.;
        ...
        private void Jugar(object sender, EventArgs e)
        {
            ...
            FichaSeleccionadaUsuario.Image = (Bitmap)Properties.Resources.ResourceManager.GetObject("_58" + turno);
