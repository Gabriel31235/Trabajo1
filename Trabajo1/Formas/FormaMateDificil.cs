...
{
    public partial class FormaMateDificil : Form
    {
        public FormaMateDificil()
        {
            InitializeComponent();
        }
        ...
        private void FormaMate_Load(object sender, EventArgs e)
        {
        ...
        public void StartTheQuiz()
        {
            ...
            addend1 = randomizer.Next(1000);
            addend2 = randomizer.Next(1000);
            ...
            multiplicand = randomizer.Next(25, 51);
            multiplier = randomizer.Next(25, 51);
            timesLeftLabel.Text = multiplicand.ToString();
            timesRightLabel.Text = multiplier.ToString();
            Multiplicar.Value = 0;

            // Fill in the division problem.
            divisor = randomizer.Next(25, 51);
            int temporaryQuotient = randomizer.Next(25, 51);
